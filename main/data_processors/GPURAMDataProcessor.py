...
DIR = os.path.dirname(os.path.abspath(__file__))#get the path of the current folder
DATA_DIR = os.path.abspath(os.path.join(DIR, "..", "data"))#go back one step to reach main and go to the data folder
