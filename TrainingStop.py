...
THRESHOLD = 4.5  #treshold we want to test. Right now it is only mean reward. We need to decide on how ot measure treshold
...
#if you want ot continue a run you need to change cmd add in between run name and no graphs put "--resume"
